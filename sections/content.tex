...
\begin{tabular}{| l | c | c | r |}
	\hline
	\textbf{Net Structure} & \textbf{Train Error} & \textbf{Validation Error}   & \parbox[t]{2.5cm}{\textbf{Rel. Impr.} \\ \textbf{Val. Error}} \\
	\hline
	...
	\hline
	\parbox[t]{5cm}{Tree Structure (5 layers 1000...200 neurons)\\and reduced Learning Rate} & 0.245 & 0.235 & 0.175 \\
	\hline
...
\begin{tabular}{| l | c | c | c | r | }
	...
	\hline
	\parbox[t]{5cm}{\textbf{Change} \textbf{(best)}} & \color{red}{\textbf{0.005}} & - & - & \color{green}{\textbf{0.114}} \\
	\hline
\end{tabular}
\end{table}
